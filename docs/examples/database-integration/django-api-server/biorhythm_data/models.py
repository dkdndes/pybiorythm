...
class BiorhythmCalculation(models.Model):
    ...
    person = models.ForeignKey(
        Person, on_delete=models.CASCADE, related_name="calculations"
    )
    ...
    target_date = models.DateField(
        help_text="Target date used as calculation reference"
    )
...
class BiorhythmData(models.Model):
    ...
    person = models.ForeignKey(
        Person, on_delete=models.CASCADE, related_name="biorhythm_entries"
    )
    ...
    def is_any_critical(self):
        ...
        return (
            self.is_physical_critical
            or self.is_emotional_critical
            or self.is_intellectual_critical
        )
...
class BiorhythmAnalysis(models.Model):
    ...
    person = models.ForeignKey(
        Person, on_delete=models.CASCADE, related_name="analyses"
    )
    ...
    analysis_parameters = models.JSONField(
        default=dict, help_text="Parameters used for analysis"
    )
