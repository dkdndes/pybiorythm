...
from biorhythm_data.models import (
    Person,
        ...
        return Response(
            {
                ...
                "statistics": {
                    ...
                    "critical_days": {
                        ...
                        "percentage": round(
                            (stats["critical_days"] / stats["count"] * 100), 2
                        )
                        if stats["count"] > 0
                        else 0,
                    },
...
def global_statistics(request):
    ...
    date_stats = BiorhythmData.objects.aggregate(
        earliest_date=Min("date"), latest_date=Max("date")
    )
    ...
    stats_data = {
        ...
        "date_range": {
            ...
            "span_days": (date_stats["latest_date"] - date_stats["earliest_date"]).days
            + 1
        ...
        "recent_activity": {
            ...
            "critical_days_percentage": round(
                (total_critical_days / total_data_points * 100), 2
            )
