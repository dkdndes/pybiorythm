...
class PersonAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("name", "birthdate", "email")}),
...
class BiorhythmDataAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Info", {"fields": ("person", "calculation", "date", "days_alive")}),
        ("Biorhythm Values", {"fields": ("physical", "emotional", "intellectual")}),
        (
            "Critical Days",
            {
                "fields": (
        ...
        (
            "Metadata",
            {"fields": ("created_at", "cycle_summary"), "classes": ("collapse",)},
        ),
    )
...
class BiorhythmAnalysisAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Results", {"fields": ("summary", "results")}),
        (
            "Metadata",
            {
