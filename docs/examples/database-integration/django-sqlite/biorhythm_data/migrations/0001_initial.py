    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Person's name or identifier", max_length=200
                    ),
                ),
                (
                    "birthdate",
                    models.DateField(help_text="Birth date for biorhythm calculations"),
                ),
                (
                    "email",
                    models.EmailField(
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Optional notes about this person"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "start_date",
                    models.DateField(help_text="Start date for calculation period"),
                ),
                (
                    "end_date",
                    models.DateField(help_text="End date for calculation period"),
                ),
                (
                    "days_calculated",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="PyBiorythm library version used",
                        max_length=50,
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Notes about this calculation"
                    ),
                ),
                (
                    "person",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "start_date",
                    models.DateField(help_text="Start date of analyzed period"),
                ),
                ...
                (
                    "results",
                    models.JSONField(help_text="Analysis results in JSON format"),
                ),
                (
                    "summary",
                    models.TextField(help_text="Human-readable summary of results"),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "days_alive",
                    models.PositiveIntegerField(help_text="Number of days since birth"),
                ),
                (
                    "physical",
                    models.FloatField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["person", "date"], name="biorhythm_d_person__59ddd4_idx"
                    ),
                    models.Index(fields=["date"], name="biorhythm_d_date_db2612_idx"),
                    models.Index(
                        fields=["days_alive"], name="biorhythm_d_days_al_d074ab_idx"
                    ),
                    models.Index(
                        fields=[
                            "is_physical_critical",
