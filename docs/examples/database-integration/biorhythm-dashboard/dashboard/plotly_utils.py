...
def create_biorhythm_line_chart(biorhythm_data: List[Dict], person_name: str) -> str:
    ...
    # Update layout
    fig.update_layout(
        title=dict(text=f"Biorhythm Cycles - {person_name}", x=0.5, font=dict(size=20)),
        xaxis_title="Date",
...
def create_cycle_distribution_chart(
    biorhythm_data: List[Dict], person_name: str
) -> str:
    """
...
def create_critical_days_calendar(biorhythm_data: List[Dict], person_name: str) -> str:
    ...
    fig.update_layout(
        title=dict(
            text=f"Critical Days Calendar - {person_name}", x=0.5, font=dict(size=20)
        ),
...
def create_cycle_phase_chart(biorhythm_data: List[Dict], person_name: str) -> str:
    ...
    cycles = [
        ...
        (
            "Intellectual",
            intellectual_phase,
            latest_data.get("intellectual", 0),
            "#45B7D1",
        ),
    ]
    ...
    fig.update_layout(
        title=dict(
            text=f"Current Cycle Phases - {person_name}", x=0.5, font=dict(size=20)
        ),
        polar=dict(
...
def create_statistics_summary_chart(
    statistics: Dict[str, Any], person_name: str
) -> str:
    """
    ...
    fig.update_layout(
        title=dict(
            text=f"Critical Days Analysis - {person_name}", x=0.5, font=dict(size=20)
        ),
...
def create_empty_chart(message: str = "No data available") -> str:
    ...
    fig.update_layout(
        title=dict(text="Biorhythm Visualization", x=0.5, font=dict(size=20)),
