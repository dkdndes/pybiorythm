...
class TestJSONOrientations:
    ...
    def test_direct_json_generation(self):
        ...
        # Test vertical JSON
        result_v = calculator.generate_timeseries_json(
        ...
        result_h = calculator.generate_timeseries_json(
...
class TestEdgeCasesAndSpecificLines:
    ...
    def test_chart_with_critical_days(self, mock_print):
        ...
        birthdate = datetime(1990, 1, 1)
        datetime(1990, 1, 12)  # 11.5 days = half physical cycle
...
class TestMainWithDifferentParams:
    ...
    def test_main_with_different_days_param(
        ...
        mock_calculator_class.assert_called_with(
            width=80, days=45, orientation="vertical"
        )
