...
class TestMainFunction:
    ...
    @patch('main.biorythm_main')
    @patch('sys.argv', ['main.py', '-y', '1990', '-m', '5', '-d', '15', '--orientation', 'horizontal', '--days', '60'])
    ...
    def test_main_incomplete_date_arguments(self, mock_exit, mock_print, mock_biorythm_main):
        ...
        mock_print.assert_called_with("Error: When using command line arguments, all date components (--year, --month, --day) must be provided")
    ...
    @patch('main.biorythm_main')
    @patch('sys.argv', ['main.py', '-y', '2000', '-m', '1', '-d', '1', '--orientation', 'json-vertical'])
...
class TestIntegration:
    ...
    def test_command_line_examples_from_help(self):
        ...
        args2 = parser.parse_args(['--year', '1990', '--month', '5', '--day', '15', '--orientation', 'horizontal'])
        assert args2.orientation == 'horizontal'
        
        # Example 3: with JSON output
        args3 = parser.parse_args(['-y', '1990', '-m', '5', '-d', '15', '--days', '30', '--orientation', 'json-vertical'])
...
class TestErrorScenarios:
    ...
    @patch('sys.argv', ['main.py', '-y', '1990', '-m', '5', '-d', '15', '--days', 'not_a_number'])
