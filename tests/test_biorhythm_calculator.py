...
class TestBiorhythmCalculator:
    ...
    def test_calculate_biorhythm_values_same_date(self):
        ...
        physical, emotional, intellectual = calc.calculate_biorhythm_values(birthdate, birthdate)
    ...
    def test_critical_day_threshold(self):
        ...
        is_critical, cycles = calc.is_critical_day(CRITICAL_DAY_THRESHOLD + 0.001, 0.1, 0.1)
        assert is_critical is False
